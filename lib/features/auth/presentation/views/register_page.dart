                ...
                children: [
                  ...
                  Form(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        children: [
                          AuthBox(size: size, hintText: 'User name', bloc: userNameBloc, errMessage: 'Enter user name'),
                         SizedBox(height:size.height*0.8*0.01 ),
                         AuthBox(size: size , hintText: 'Email', bloc: emailBloc, errMessage: 'Enter an email'),
                          SizedBox(height:size.height*0.8*0.01 ),
                          AuthBox(size: size , hintText: 'Password', bloc: passwordBloc, errMessage: 'Enter password'),
                          SizedBox(height:size.height*0.8*0.01 ),
                          AuthBox(size: size , hintText: 'validate password', bloc:checkPasswordBloc, errMessage: 'Enter validate password'),
                          SizedBox(height:size.height*0.8*0.08 ),
                          RegisterButton(size: size, emailBloc: emailBloc, passwordBloc: passwordBloc, formkey: _formkey, usernameBloc: userNameBloc, checkPassword: checkPasswordBloc)
